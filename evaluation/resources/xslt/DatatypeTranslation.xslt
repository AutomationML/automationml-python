...
<xsl:stylesheet version="2.0" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://opcfoundation.org/UA/2011/03/UANodeSet.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#default xsi xsl exslt fn" xmlns:exslt="http://exslt.org/common">
	...
	<xsl:variable name="DataTypes">
		...
		<DataType OPCAlias="String" OPCNodeId="i=12" AML="xs:ID"/>
		...
		<DataType OPCAlias="DateTime" OPCNodeId="i=13" AML="xs:dateTime"/>
		<DataType OPCAlias="String" OPCNodeId="i=12" AML="xs:token"/>
		<!-- TODO: überprüfen -->
